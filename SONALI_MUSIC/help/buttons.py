...
class BUTTONS(object):
    ...
    [
        ...
        InlineKeyboardButton("• ᴡᴇʟᴄᴏᴍᴇ •", callback_data="TOOL_BACK HELP_15"),
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("˹ ᴄσηᴛᴧᴄᴛ ˼", url="https://t.me/lll_TOXICC_PAPA_lll"),
            InlineKeyboardButton("⌯ ʙᴧᴄᴋ ⌯", callback_data="MAIN_CP"),
        ]
        ]
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("˹ sυᴘᴘσʀᴛ ˼", url="https://t.me/+qzEliUch7GcwOTA1"),
            InlineKeyboardButton("˹ υᴘᴅᴧᴛєs ˼", url="https://t.me/kuruvibotz"),
        ],
        [  
